...
db_alzn = Database('Pb-Sn_JDP.tdb')
my_phases_pbsn = ['LIQUID', 'FCC_A1', 'BCT_A5']
...
binplot(db_alzn, ['PB', 'SN', 'VA'] , my_phases_pbsn, {v.X('SN'):(0,1,0.02), v.T: (273, 1000, 10), v.P:101325, v.N: 1}, plot_kwargs={'ax': axes})
