...
model_type = 'Ideal Solution Model'
...
DeltaG_mix_FCC = lambda X_2, T:  T*S_ideal(X_2) + (1-X_2)*FCC_hanging_Pd(T) + X_2*FCC_hanging_Re(T)
DeltaG_mix_HCP = lambda X_2, T: T*S_ideal(X_2) + (1-X_2)*HCP_hanging_Pd(T) + X_2*HCP_hanging_Re(T)
DeltaG_mix_L = lambda X_2, T: T*S_ideal(X_2) + (1-X_2)*Liq_hanging_Pd(T) + X_2*Liq_hanging_Re(T)
